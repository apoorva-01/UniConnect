...
export default function BioCard(props) {
  return (
    ...
    >
      <CardContent>
        <Image src="/images/1.jpeg" sx={{}} width={300} height={350} alt={"image"} />
        ...
        >
          ...
          <IconButton size="sm" variant="plain" color="neutral">
            <SvgIcon>
              <Link href={props.facebook} passHref>
                <svg
          ...
          <IconButton size="sm" variant="plain" color="neutral">
            <Link href={props.snapchat} passHref>
              <SvgIcon>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
          ...
          <Link href={props.whatsapp} passHref>
            <IconButton size="sm" variant="plain" color="neutral">
              <WhatsAppIcon />
            </IconButton>
          </Link>
