  ...
  return (
    <Card
      sx={{
        ...
        maxWidth: '100%',
        boxShadow: 'lg',
        backgroundImage: `url(${props.image})`, // Add the background image URL here
        backgroundSize: 'cover', // Adjust the background size as needed
      }}
    >
      <CardContent>
        {/* <Avatar src="/images/1.jpeg" sx={{ '--Avatar-size': '4rem' }} /> */}

        <Typography sx={{ color: "#fff", paddingTop: "10rem", fontWeight: "800", fontSize: "1.4rem" }} level="title-lg">{props.name}</Typography>
        <Typography sx={{ color: "#fff", fontWeight: "600", fontSize: "1rem", maxWidth: '24ch' }}>
          {props.bio}
        </Typography>
